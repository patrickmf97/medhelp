...
export function DashboardShell({ area, children }: { area: 'Aluno' | 'Editorial' | 'Admin'; children: ReactNode }) {
  ...
  const links: ReadonlyArray<readonly [string, string]> = admin ? [['Visão geral', '/admin'], ['Conteúdos', '/editor'], ['Pagamentos', '/admin/pagamentos']] : editorial ? [['Conteúdos', '/editor'], ['Ver plataforma', '/explorar']] : [['Hoje', '/aluno'], ['Explorar', '/explorar'], ['Meu progresso', '/aluno/progresso']];
